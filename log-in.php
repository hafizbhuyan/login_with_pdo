        ...
        <div id="wrapper">
            <div id="left">
                <div id="signin">
                    ...
                    <form action="log-in-script.php" method="POST">
                        <div id="alert_msg">
                        ...
                        <button name="log-in-user" type="submit" class="primary-btn">Log In</button>
                    </form>
                    <div class="links">
                    ...
                    <a href="/sign-up.php" class="secondary-btn">Create an account</a>
                </div>
